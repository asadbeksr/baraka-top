...
export const env = createEnv({
  server: {
    ...
    NEXT_PUBLIC_YMAPS_API_KEY: z.string().min(1),
  ...
  client: {
    ...
    NEXT_PUBLIC_YMAPS_API_KEY: z.string().min(1),
    NEXT_PUBLIC_RTSP_STREAM_URL: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_YMAPS_API_KEY: process.env.NEXT_PUBLIC_YMAPS_API_KEY,
    NEXT_PUBLIC_RTSP_STREAM_URL: process.env.NEXT_PUBLIC_RTSP_STREAM_URL
    // Stripe
